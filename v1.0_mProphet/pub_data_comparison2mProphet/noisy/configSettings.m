...
settings.multFactor = 10; % it corrects for possible ( but discouraged) multiplicative differences in the constantTarget (i.e., reference) amount. If the reference amount in your real sampe is N times less than the amount spiked in the calibration experiment then you want to multiply by N.
