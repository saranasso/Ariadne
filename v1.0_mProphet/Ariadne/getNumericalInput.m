...
function input = getNumericalInput(prompt,dlg_title,num_lines,def)
% it keeps on asking for a numeric input value till it gets it
...
while isnan(input)
    ...
    input = getNumericalInput(prompt,dlg_title,num_lines,def);
end
